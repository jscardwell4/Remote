...
extension NamedModelObject {
  ...
  */
  static func nameFormFieldTemplate(#context: NSManagedObjectContext) -> FieldTemplate {
    ...
    return .Text(value: "", placeholder: placeholder, validation: validation)
  }
  ...
  :returns: FieldTemplate
  */
  static func pickerFormFieldTemplate(#context: NSManagedObjectContext, optional: Bool = true) -> FieldTemplate {
    ...
    return .Picker(value: initial, choices: choices)
  }
