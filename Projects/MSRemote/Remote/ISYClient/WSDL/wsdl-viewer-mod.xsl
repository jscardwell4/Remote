...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
-->
<xsl:param name="ENABLE-DOCS-ONLY" select="false()"/>

<xsl:param name="ENABLE-HEADING" select="true()"/>
<xsl:param name="ENABLE-SERVICE-INFO" select="true()"/>
...
<xsl:template match="*[local-name(.) = 'documentation']" mode="documentation.render">
	<xsl:if test="not($ENABLE-DOCS-ONLY) and $ENABLE-DESCRIPTION and string-length(.) &gt; 0">
...
<xsl:if test="$ENABLE-HEADING and not($ENABLE-DOCS-ONLY)">  
	<div id="header">
		<div id="headertitle">
...
<xsl:if test="not($ENABLE-DOCS-ONLY)">
    <div id="services">
...
<xsl:if test="$ENABLE-DOCS-ONLY">
<xsl:attribute name="style">padding-left: 21px</xsl:attribute>
</xsl:if>
...
<xsl:if test="$ENABLE-SERVICE-INFO">  
    <div class="page">
