...
public class DrawingKit : NSObject {
  ...
  public class func drawRoundishButtonWithText(#color: UIColor, buttonText: String, addGloss: Bool, textFrame: CGRect, radius: CGFloat) {
    ...
    //// Frames
    let frame = CGRectMake(textFrame.origin.x, textFrame.origin.y, textFrame.size.width, textFrame.size.height)
    ...
    let roundishButtonRect = CGRectMake(group.minX + floor(group.width * 0.00000 + 0.5), group.minY + floor(group.height * 0.00000 + 0.5), floor(group.width * 1.00000 + 0.5) - floor(group.width * 0.00000 + 0.5), floor(group.height * 1.00000 + 0.5) - floor(group.height * 0.00000 + 0.5))
...
//    UIRectClip(roundishButtonRect)
    ...
    DrawingKit.drawRoundishButtonBase(frame: CGRectMake(0, 0, roundishButtonRect.size.width, roundishButtonRect.size.height), color: color, radius: radius)
    CGContextRestoreGState(context)
    ...
    //// label Drawing
    let labelRect = CGRectMake(group.minX + floor(group.width * 0.00000 + 0.5), group.minY + floor(group.height * 0.00000 + 0.5), floor(group.width * 1.00000 + 0.5) - floor(group.width * 0.00000 + 0.5), floor(group.height * 1.00000 + 0.5) - floor(group.height * 0.00000 + 0.5))
    CGContextSaveGState(context)
    ...
    let labelFontAttributes = [NSFontAttributeName: UIFont(name: "HelveticaNeue-Bold", size: appliedFontSize)!, NSForegroundColorAttributeName: strokeColor, NSParagraphStyleAttributeName: labelStyle]
    ...
    let labelInnerShadowFontAttributes = [NSFontAttributeName: UIFont(name: "HelveticaNeue-Bold", size: appliedFontSize)!, NSForegroundColorAttributeName: (DrawingKit.cutoutShadow.shadowColor as! UIColor), NSParagraphStyleAttributeName: labelStyle]
    ...
    if (addGloss) {
      ...
      let glossOverlayRect = CGRectMake(group.minX + floor(group.width * 0.00000 + 0.5), group.minY + floor(group.height * 0.00000 + 0.5), floor(group.width * 1.00000 + 0.5) - floor(group.width * 0.00000 + 0.5), floor(group.height * 1.00000 + 0.5) - floor(group.height * 0.00000 + 0.5))
      CGContextSaveGState(context)
