...
#define COMMAND_LOG_CONTEXT    (1 << 10)
#define BUILDING_LOG_CONTEXT   (1 << 11)
...
#define COMMAND_LC    COMMAND_LOG_CONTEXT
#define BUILDING_LC   BUILDING_LOG_CONTEXT
...
#define COMMAND_F      COMMAND_LC
#define COMMAND_C      CONSOLE_LC
#define COMMAND_F_C    COMMAND_LC|CONSOLE_LC
#define BUILDING_F     BUILDING_LC
#define BUILDING_C     CONSOLE_LC
#define BUILDING_F_C   BUILDING_LC|CONSOLE_LC
