...
static BankObjectGroup * defaultGalleryGroup;
...
+ (BankObjectGroup *)defaultGalleryGroupInContext:(NSManagedObjectContext *)context {
    ...
    [context performBlockAndWait:^{
                 ...
                 NSEntityDescription * entity = [NSEntityDescription entityForName:@"BankObjectGroup"
...
+ (BankObjectGroup *)newGalleryGroupWithName:(NSString *)name
                                inContext:(NSManagedObjectContext *)context {
    BankObjectGroup * galleryGroup =
        [NSEntityDescription insertNewObjectForEntityForName:@"BankObjectGroup" inManagedObjectContext:context];
...
- (void)addImagesObject:(REImage *)value {
 ...
 * removeImagesObject:
 */
- (void)removeImagesObject:(REImage *)value {
    NSSet * changedObjects = [[NSSet alloc] initWithObjects:&value count:1];
