...
//        for (UIBarButtonItem * buttonItem in _singleSelButtons) {
//            buttonItem.enabled = NO;
//        }

        [_anySelButtons setValue:@NO forKeyPath:@"enabled"];
//        for (UIBarButtonItem * buttonItem in _anySelButtons) {
//            buttonItem.enabled = NO;
//        }

        [_multiSelButtons setValue:@NO forKeyPath:@"enabled"];
//        for (UIBarButtonItem * buttonItem in _multiSelButtons) {
//            buttonItem.enabled = NO;
//        }
    } else {
...
//        for (UIBarButtonItem * buttonItem in _singleSelButtons) {
//            buttonItem.enabled = !multipleButtonsSelected;
//        }
