...
- (void)restoreCurrentValues {
    if (_currentIconImage) {
        ...
        [_button setIcon:_currentIconImage forState:_controlState];
        _removeIconButton.hidden = NO;
    } else {
        [_iconNameButton setTitle:@"Select Icon"  forState:UIControlStateNormal];
        [_button setIcon:nil forState:_controlState];
    ...
    if (_currentColor) {
        ...
        [_button setIconColor:_currentColor forState:_controlState];
    }
}
