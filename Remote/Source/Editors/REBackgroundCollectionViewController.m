                  ...
                  cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row)
    {
        BOBackgroundImage * backgroundImage = self.backgrounds[indexPath.row - 1];
         ...
         ^{
             NSFetchRequest * request = [NSFetchRequest
                                         fetchRequestWithEntityName:
                                             ClassString([BOBackgroundImage class])];
...
- (void)selectBackgroundImage:(BOBackgroundImage *)backgroundImage
{
    ...
    {
        NSUInteger index = [self.backgrounds indexOfObjectPassingTest:
                            ^BOOL (BOBackgroundImage * obj, NSUInteger idx, BOOL * stop)
                            {
...
- (void)setInitialImage:(BOBackgroundImage *)initialImage
{
