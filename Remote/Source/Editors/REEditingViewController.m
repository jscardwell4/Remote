...
+ (Class)subelementClass { return [REView class]; }

+ (Class)elementClass { return [REView class]; }
...
- (NSString *)shortDescription { return (_sourceView?_sourceView.displayName:[self description]); }
