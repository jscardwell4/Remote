...
@property (strong, nonatomic) BOIconImage     * initialIconImage;
@property (strong, nonatomic) NSValue              * currentEdgeInsets;
@property (strong, nonatomic) UIColor              * currentColor;
@property (strong, nonatomic) BOIconImage     * currentIconImage;
...
- (void)restoreCurrentValues {
    ...
    if (_currentColor) {
        ...
        _button.icons.iconColors[_controlState] = _currentColor;
    }
}
