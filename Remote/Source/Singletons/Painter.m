...
+ (void)drawLEDButtons
{
    ...
    //// Color Declarations
    UIColor* backgroundColorTop = [UIColor colorWithRed: 0.184 green: 0.211 blue: 0.226 alpha: 1];
    CGFloat backgroundColorTopRGBA[4];
    [backgroundColorTop getRed: &backgroundColorTopRGBA[0] green: &backgroundColorTopRGBA[1] blue: &backgroundColorTopRGBA[2] alpha: &backgroundColorTopRGBA[3]];

    UIColor* backgroundColorBottom = [UIColor colorWithRed: (backgroundColorTopRGBA[0] * 0.5) green: (backgroundColorTopRGBA[1] * 0.5) blue: (backgroundColorTopRGBA[2] * 0.5) alpha: (backgroundColorTopRGBA[3] * 0.5 + 0.5)];
    UIColor* trackColor = [UIColor colorWithRed: (backgroundColorTopRGBA[0] * 0.597) green: (backgroundColorTopRGBA[1] * 0.597) blue: (backgroundColorTopRGBA[2] * 0.597) alpha: (backgroundColorTopRGBA[3] * 0.597 + 0.403)];
    UIColor* innerShineColor = [UIColor colorWithRed: 0.84 green: 0.84 blue: 0.84 alpha: 0.17];
    UIColor* trackInnerShadowColor = [UIColor colorWithRed: 0.028 green: 0.028 blue: 0.028 alpha: 1];
    UIColor* buttColorTop = [UIColor colorWithRed: 0.151 green: 0.178 blue: 0.199 alpha: 1];
    CGFloat buttColorTopRGBA[4];
    [buttColorTop getRed: &buttColorTopRGBA[0] green: &buttColorTopRGBA[1] blue: &buttColorTopRGBA[2] alpha: &buttColorTopRGBA[3]];

    UIColor* shineTop = [UIColor colorWithRed: (buttColorTopRGBA[0] * 0.916 + 0.084) green: (buttColorTopRGBA[1] * 0.916 + 0.084) blue: (buttColorTopRGBA[2] * 0.916 + 0.084) alpha: (buttColorTopRGBA[3] * 0.916 + 0.084)];
    CGFloat shineTopHSBA[4];
    [shineTop getHue: &shineTopHSBA[0] saturation: &shineTopHSBA[1] brightness: &shineTopHSBA[2] alpha: &shineTopHSBA[3]];

    UIColor* shineBottom = [UIColor colorWithHue: shineTopHSBA[0] saturation: shineTopHSBA[1] brightness: 0.1 alpha: shineTopHSBA[3]];
    UIColor* buttColorBottom = [UIColor colorWithRed: (buttColorTopRGBA[0] * 0.4) green: (buttColorTopRGBA[1] * 0.4) blue: (buttColorTopRGBA[2] * 0.4) alpha: (buttColorTopRGBA[3] * 0.4 + 0.6)];
    UIColor* lightBase = [UIColor colorWithRed: 0.304 green: 0.749 blue: 1 alpha: 1];
    CGFloat lightBaseRGBA[4];
    [lightBase getRed: &lightBaseRGBA[0] green: &lightBaseRGBA[1] blue: &lightBaseRGBA[2] alpha: &lightBaseRGBA[3]];

    CGFloat lightBaseHSBA[4];
    [lightBase getHue: &lightBaseHSBA[0] saturation: &lightBaseHSBA[1] brightness: &lightBaseHSBA[2] alpha: &lightBaseHSBA[3]];

    UIColor* shineCenter = [UIColor colorWithRed: (lightBaseRGBA[0] * 0.7 + 0.3) green: (lightBaseRGBA[1] * 0.7 + 0.3) blue: (lightBaseRGBA[2] * 0.7 + 0.3) alpha: (lightBaseRGBA[3] * 0.7 + 0.3)];
    UIColor* lightUp = [UIColor colorWithRed: (lightBaseRGBA[0] * 0.4 + 0.6) green: (lightBaseRGBA[1] * 0.4 + 0.6) blue: (lightBaseRGBA[2] * 0.4 + 0.6) alpha: (lightBaseRGBA[3] * 0.4 + 0.6)];
    CGFloat lightUpHSBA[4];
    [lightUp getHue: &lightUpHSBA[0] saturation: &lightUpHSBA[1] brightness: &lightUpHSBA[2] alpha: &lightUpHSBA[3]];

    UIColor* symbolColor = [UIColor colorWithHue: lightUpHSBA[0] saturation: lightUpHSBA[1] brightness: 0.6 alpha: lightUpHSBA[3]];
    UIColor* lightOffUp = [UIColor colorWithHue: lightBaseHSBA[0] saturation: lightBaseHSBA[1] brightness: 0.264 alpha: lightBaseHSBA[3]];
    UIColor* lightOffDown = [UIColor colorWithRed: (lightBaseRGBA[0] * 0.2) green: (lightBaseRGBA[1] * 0.2) blue: (lightBaseRGBA[2] * 0.2) alpha: (lightBaseRGBA[3] * 0.2 + 0.8)];
    UIColor* lightDown = [UIColor colorWithRed: (lightBaseRGBA[0] * 1) green: (lightBaseRGBA[1] * 1) blue: (lightBaseRGBA[2] * 1) alpha: (lightBaseRGBA[3] * 1 + 0)];
    UIColor* ledStroke = [lightDown colorWithAlphaComponent: 1];
    UIColor* lightGlowColor = [UIColor colorWithRed: (lightBaseRGBA[0] * 0.3 + 0.7) green: (lightBaseRGBA[1] * 0.3 + 0.7) blue: (lightBaseRGBA[2] * 0.3 + 0.7) alpha: (lightBaseRGBA[3] * 0.3 + 0.7)];
    ...
    NSArray* shineGradientColors = [NSArray arrayWithObjects:
                                    (id)shineTop.CGColor,
                                    (id)shineBottom.CGColor, nil];
    CGFloat shineGradientLocations[] = {0, 1};
    ...
    NSArray* buttonGradientColors = [NSArray arrayWithObjects:
                                     (id)buttColorTop.CGColor,
                                     (id)buttColorBottom.CGColor, nil];
    ...
    NSArray* lightOFFGradientColors = [NSArray arrayWithObjects:
                                       (id)lightOffUp.CGColor,
                                       (id)lightOffDown.CGColor, nil];
    CGFloat lightOFFGradientLocations[] = {0, 1};
    CGGradientRef lightOFFGradient = CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef)lightOFFGradientColors, lightOFFGradientLocations);
    NSArray* lightONGradientColors = [NSArray arrayWithObjects:
                                      (id)lightUp.CGColor,
                                      (id)lightDown.CGColor, nil];
    CGFloat lightONGradientLocations[] = {0, 1};
    CGGradientRef lightONGradient = CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef)lightONGradientColors, lightONGradientLocations);
    NSArray* shineLightGradientColors = [NSArray arrayWithObjects:
                                         (id)shineCenter.CGColor,
                                         (id)[UIColor colorWithRed: 0.257 green: 0.412 blue: 0.5 alpha: 0.5].CGColor,
                                         (id)shineColor.CGColor, nil];
    CGFloat shineLightGradientLocations[] = {0, 0.3, 0.76};
    CGGradientRef shineLightGradient = CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef)shineLightGradientColors, shineLightGradientLocations);
    ...
    CGRect frameButton1 = CGRectMake(47, 91, 69, 46);
    CGRect frameButton2 = CGRectMake(117, 93, 67, 42);
    CGRect frameButton3 = CGRectMake(186, 93, 67, 42);

    //// Subframes
    CGRect symbolFrameChat = CGRectMake(CGRectGetMinX(frameButton3) + floor((CGRectGetWidth(frameButton3) - 63) * 0.50000 + 0.5), CGRectGetMinY(frameButton3) + floor((CGRectGetHeight(frameButton3) - 38) * 0.50000 + 0.5), 63, 38);
    CGRect chat = CGRectMake(CGRectGetMinX(symbolFrameChat) + floor((CGRectGetWidth(symbolFrameChat) - 20) * 0.51163 + 0.5), CGRectGetMinY(symbolFrameChat) + floor((CGRectGetHeight(symbolFrameChat) - 20) * 0.44444 + 0.5), 20, 20);
    CGRect symbolFrameCamera = CGRectMake(CGRectGetMinX(frameButton2) + floor((CGRectGetWidth(frameButton2) - 63) * 0.50000 + 0.5), CGRectGetMinY(frameButton2) + floor((CGRectGetHeight(frameButton2) - 38) * 0.50000 + 0.5), 63, 38);
    CGRect camera = CGRectMake(CGRectGetMinX(symbolFrameCamera) + floor((CGRectGetWidth(symbolFrameCamera) - 20) * 0.51163 + 0.5), CGRectGetMinY(symbolFrameCamera) + floor((CGRectGetHeight(symbolFrameCamera) - 20) * 0.44444 + 0.5), 20, 20);
    CGRect group = CGRectMake(CGRectGetMinX(frameButton1) + 1, CGRectGetMinY(frameButton1) + 2, CGRectGetWidth(frameButton1) - 2, CGRectGetHeight(frameButton1) - 5);
    CGRect symbolFrameAperture = CGRectMake(CGRectGetMinX(frameButton1) + floor((CGRectGetWidth(frameButton1) - 63) * 0.50000 + 0.5), CGRectGetMinY(frameButton1) + floor((CGRectGetHeight(frameButton1) - 38) * 0.50000 + 0.5), 63, 38);
    CGRect apertureSymbol = CGRectMake(CGRectGetMinX(symbolFrameAperture) + floor((CGRectGetWidth(symbolFrameAperture) - 20) * 0.51163 + 0.5), CGRectGetMinY(symbolFrameAperture) + floor((CGRectGetHeight(symbolFrameAperture) - 20) * 0.44444 + 0.5), 20, 20);
    ...
    CGContextDrawLinearGradient(context, backgroundGradient, CGPointMake(150, 0), CGPointMake(150, 225), 0);
    UIGraphicsPopContext();
    ...
    {
        //// track Drawing
        UIBezierPath* trackPath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(CGRectGetMinX(frameTrack) + 9, CGRectGetMinY(frameTrack) + 15, 213, 50) cornerRadius: 4];
        UIGraphicsPushContext(context);
        ...
        ////// track Inner Shadow
        CGRect trackBorderRect = CGRectInset([trackPath bounds], -trackInnerBlurRadius, -trackInnerBlurRadius);
        trackBorderRect = CGRectOffset(trackBorderRect, -trackInnerOffset.width, -trackInnerOffset.height);
    ...
    //// button1
    {
        ...
        CGRect buttonOuter1Rect = CGRectMake(CGRectGetMinX(frameButton1) + 1, CGRectGetMinY(frameButton1) + 2, CGRectGetWidth(frameButton1) - 2, CGRectGetHeight(frameButton1) - 4);
        ...
        CGContextDrawLinearGradient(context, shineGradient,
                                    CGPointMake(CGRectGetMidX(buttonOuter1Rect), CGRectGetMinY(buttonOuter1Rect)),
                                    CGPointMake(CGRectGetMidX(buttonOuter1Rect), CGRectGetMaxY(buttonOuter1Rect)),
                                    0);
        UIGraphicsPopContext();


        //// buttonInner1 Drawing
        CGRect buttonInner1Rect = CGRectMake(CGRectGetMinX(frameButton1) + 1.5, CGRectGetMinY(frameButton1) + 3, CGRectGetWidth(frameButton1) - 3, CGRectGetHeight(frameButton1) - 6);
        ...
        CGContextDrawLinearGradient(context, buttonGradient,
                                    CGPointMake(CGRectGetMidX(buttonInner1Rect), CGRectGetMinY(buttonInner1Rect)),
                                    CGPointMake(CGRectGetMidX(buttonInner1Rect), CGRectGetMaxY(buttonInner1Rect)),
                                    0);
        UIGraphicsPopContext();
        ...
        //// Group
        {
            ...
            CGRect buttInnerShine1Rect = CGRectMake(CGRectGetMinX(group) + floor(CGRectGetWidth(group) * 0.00746) + 0.5, CGRectGetMinY(group) + floor(CGRectGetHeight(group) * 0.00000 + 0.5), floor(CGRectGetWidth(group) * 0.99254) - floor(CGRectGetWidth(group) * 0.00746), floor(CGRectGetHeight(group) * 1.00000 + 0.5) - floor(CGRectGetHeight(group) * 0.00000 + 0.5));
            UIBezierPath* buttInnerShine1Path = [UIBezierPath bezierPathWithRect: buttInnerShine1Rect];
            UIGraphicsPushContext(context);
            [buttInnerShine1Path addClip];
            CGFloat buttInnerShine1ResizeRatio = MIN(CGRectGetWidth(buttInnerShine1Rect) / 66, CGRectGetHeight(buttInnerShine1Rect) / 41);
            CGContextDrawRadialGradient(context, shineLightGradient,
                                        CGPointMake(CGRectGetMidX(buttInnerShine1Rect) + 0 * buttInnerShine1ResizeRatio, CGRectGetMidY(buttInnerShine1Rect) + -30.13 * buttInnerShine1ResizeRatio), 7.18 * buttInnerShine1ResizeRatio,
                                        CGPointMake(CGRectGetMidX(buttInnerShine1Rect) + 0 * buttInnerShine1ResizeRatio, CGRectGetMidY(buttInnerShine1Rect) + -20 * buttInnerShine1ResizeRatio), 83.63 * buttInnerShine1ResizeRatio,
        ...
        //// aperture symbol
        {
            ...
            [aperturePath moveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.66162 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.43688 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.83947 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.13488 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addCurveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.50000 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.00000 * CGRectGetHeight(apertureSymbol)) controlPoint1: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.75025 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.05181 * CGRectGetHeight(apertureSymbol)) controlPoint2: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.63159 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.00000 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addCurveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.40900 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.00916 * CGRectGetHeight(apertureSymbol)) controlPoint1: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.46881 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.00000 * CGRectGetHeight(apertureSymbol)) controlPoint2: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.43859 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.00372 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.66162 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.43688 * CGRectGetHeight(apertureSymbol))];
            [aperturePath closePath];
            [aperturePath moveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.62347 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.62500 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.98228 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.62500 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addCurveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 1.00000 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.50000 * CGRectGetHeight(apertureSymbol)) controlPoint1: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.99269 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.58484 * CGRectGetHeight(apertureSymbol)) controlPoint2: CGPointMake(CGRectGetMinX(apertureSymbol) + 1.00000 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.54347 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addCurveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.88366 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.18297 * CGRectGetHeight(apertureSymbol)) controlPoint1: CGPointMake(CGRectGetMinX(apertureSymbol) + 1.00000 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.37897 * CGRectGetHeight(apertureSymbol)) controlPoint2: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.95531 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.26947 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.62347 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.62500 * CGRectGetHeight(apertureSymbol))];
            [aperturePath closePath];
            [aperturePath moveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.51562 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.31250 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.34663 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.02650 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addCurveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.03713 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.31250 * CGRectGetHeight(apertureSymbol)) controlPoint1: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.20600 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.07209 * CGRectGetHeight(apertureSymbol)) controlPoint2: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.09228 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.17644 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.51562 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.31250 * CGRectGetHeight(apertureSymbol))];
            [aperturePath closePath];
            [aperturePath moveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.48853 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.68750 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.65700 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.97241 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addCurveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.96291 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.68750 * CGRectGetHeight(apertureSymbol)) controlPoint1: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.79603 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.92603 * CGRectGetHeight(apertureSymbol)) controlPoint2: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.90822 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.82238 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.48853 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.68750 * CGRectGetHeight(apertureSymbol))];
            [aperturePath closePath];
            [aperturePath moveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.37828 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.37500 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.01769 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.37500 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addCurveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.00000 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.50000 * CGRectGetHeight(apertureSymbol)) controlPoint1: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.00725 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.41516 * CGRectGetHeight(apertureSymbol)) controlPoint2: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.00000 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.45653 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addCurveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.11738 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.81838 * CGRectGetHeight(apertureSymbol)) controlPoint1: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.00000 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.62159 * CGRectGetHeight(apertureSymbol)) controlPoint2: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.04516 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.73156 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.37828 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.37500 * CGRectGetHeight(apertureSymbol))];
            [aperturePath closePath];
            [aperturePath moveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.34119 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.56128 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.16169 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.86622 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addCurveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.50000 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 1.00000 * CGRectGetHeight(apertureSymbol)) controlPoint1: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.25084 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.94850 * CGRectGetHeight(apertureSymbol)) controlPoint2: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.36903 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 1.00000 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addCurveToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.59503 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.99047 * CGRectGetHeight(apertureSymbol)) controlPoint1: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.53253 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 1.00000 * CGRectGetHeight(apertureSymbol)) controlPoint2: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.56422 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.99634 * CGRectGetHeight(apertureSymbol))];
            [aperturePath addLineToPoint: CGPointMake(CGRectGetMinX(apertureSymbol) + 0.34119 * CGRectGetWidth(apertureSymbol), CGRectGetMinY(apertureSymbol) + 0.56128 * CGRectGetHeight(apertureSymbol))];
            [aperturePath closePath];
            UIGraphicsPushContext(context);
    ...
    //// button2
    {
        ...
        CGRect buttonOuter2Rect = CGRectMake(CGRectGetMinX(frameButton2), CGRectGetMinY(frameButton2), 67, 42);
        UIBezierPath* buttonOuter2Path = [UIBezierPath bezierPathWithRect: buttonOuter2Rect];
        UIGraphicsPushContext(context);
        [buttonOuter2Path addClip];
        CGContextDrawLinearGradient(context, shineGradient,
                                    CGPointMake(CGRectGetMidX(buttonOuter2Rect), CGRectGetMinY(buttonOuter2Rect)),
                                    CGPointMake(CGRectGetMidX(buttonOuter2Rect), CGRectGetMaxY(buttonOuter2Rect)),
                                    0);
        UIGraphicsPopContext();


        //// buttonInner2 Drawing
        CGRect buttonInner2Rect = CGRectMake(CGRectGetMinX(frameButton2) + 0.5, CGRectGetMinY(frameButton2) + 1, 66, 40);
        UIBezierPath* buttonInner2Path = [UIBezierPath bezierPathWithRect: buttonInner2Rect];
        UIGraphicsPushContext(context);
        [buttonInner2Path addClip];
        CGContextDrawLinearGradient(context, buttonGradient,
                                    CGPointMake(CGRectGetMidX(buttonInner2Rect), CGRectGetMinY(buttonInner2Rect)),
                                    CGPointMake(CGRectGetMidX(buttonInner2Rect), CGRectGetMaxY(buttonInner2Rect)),
                                    0);
        UIGraphicsPopContext();
        ...
        //// Camera
        {
            ...
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.71288 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.00000 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 0.76378 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.01775 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.74047 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.00000 * CGRectGetHeight(camera))];
            ...
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.48175 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.04328 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 0.51334 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.00000 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.48981 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.01819 * CGRectGetHeight(camera))];
            ...
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.00000 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.37500 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 0.05597 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.25000 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.00000 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.30597 * CGRectGetHeight(camera))];
            ...
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.87500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.25000 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 1.00000 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.30597 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.94409 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.25000 * CGRectGetHeight(camera))];
            ...
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.12500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.43750 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 0.15297 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.50000 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.12500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.47203 * CGRectGetHeight(camera))];
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.18750 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.37500 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 0.12500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.40297 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.15297 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.37500 * CGRectGetHeight(camera))];
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.25000 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.43750 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 0.22203 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.37500 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.25000 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.40297 * CGRectGetHeight(camera))];
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.18750 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.50000 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 0.25000 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.47203 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.22203 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.50000 * CGRectGetHeight(camera))];
            [bezier7Path closePath];
            ...
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.37500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.62500 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 0.48694 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.87500 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.37500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.76306 * CGRectGetHeight(camera))];
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.62500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.37500 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 0.37500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.48694 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.48694 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.37500 * CGRectGetHeight(camera))];
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.87500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.62500 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 0.76306 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.37500 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.87500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.48694 * CGRectGetHeight(camera))];
            [bezier7Path addCurveToPoint: CGPointMake(CGRectGetMinX(camera) + 0.62500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.87500 * CGRectGetHeight(camera)) controlPoint1: CGPointMake(CGRectGetMinX(camera) + 0.87500 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.76306 * CGRectGetHeight(camera)) controlPoint2: CGPointMake(CGRectGetMinX(camera) + 0.76306 * CGRectGetWidth(camera), CGRectGetMinY(camera) + 0.87500 * CGRectGetHeight(camera))];
            [bezier7Path closePath];
            [symbolColor setFill];
            [bezier7Path fill];
        }
    ...
    //// button3
    {
        ...
        CGRect buttonOuter3Rect = CGRectMake(CGRectGetMinX(frameButton3), CGRectGetMinY(frameButton3), 67, 42);
        UIBezierPath* buttonOuter3Path = [UIBezierPath bezierPathWithRect: buttonOuter3Rect];
        UIGraphicsPushContext(context);
        [buttonOuter3Path addClip];
        CGContextDrawLinearGradient(context, shineGradient,
                                    CGPointMake(CGRectGetMidX(buttonOuter3Rect), CGRectGetMinY(buttonOuter3Rect)),
                                    CGPointMake(CGRectGetMidX(buttonOuter3Rect), CGRectGetMaxY(buttonOuter3Rect)),
                                    0);
        UIGraphicsPopContext();


        //// buttonInner3 Drawing
        CGRect buttonInner3Rect = CGRectMake(CGRectGetMinX(frameButton3) + 0.5, CGRectGetMinY(frameButton3) + 1, 66, 40);
        UIBezierPath* buttonInner3Path = [UIBezierPath bezierPathWithRect: buttonInner3Rect];
        UIGraphicsPushContext(context);
        [buttonInner3Path addClip];
        CGContextDrawLinearGradient(context, buttonGradient,
                                    CGPointMake(CGRectGetMidX(buttonInner3Rect), CGRectGetMinY(buttonInner3Rect)),
                                    CGPointMake(CGRectGetMidX(buttonInner3Rect), CGRectGetMaxY(buttonInner3Rect)),
                                    0);
        UIGraphicsPopContext();
        ...
        //// Chat
        {
            ...
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.78419 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.50319 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.81094 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.42500 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.80128 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.46587 * CGRectGetHeight(chat))];
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.87500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.62500 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.87428 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.51819 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.87500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.59156 * CGRectGetHeight(chat))];
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.75013 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.75000 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.87500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.65600 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.87500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.75000 * CGRectGetHeight(chat))];
            ...
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.42506 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.85009 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.54359 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.75000 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.47069 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.78931 * CGRectGetHeight(chat))];
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.37500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.75000 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.39478 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.82716 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.37500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.79078 * CGRectGetHeight(chat))];
            ...
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.38622 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.56475 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.37500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.60028 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.37941 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.58081 * CGRectGetHeight(chat))];
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.37500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.56250 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.38256 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.56409 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.37891 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.56250 * CGRectGetHeight(chat))];
            ...
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.25013 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.62500 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.25231 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.58184 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.25013 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.60253 * CGRectGetHeight(chat))];
            ...
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.50000 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 1.00000 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.25013 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.88806 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.36194 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 1.00000 * CGRectGetHeight(chat))];
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.62500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.87500 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.50000 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.93091 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.55591 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.87500 * CGRectGetHeight(chat))];
            ...
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 1.00000 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.62500 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.87500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.87500 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 1.00000 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.80469 * CGRectGetHeight(chat))];
            [bezier8Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.81178 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.38166 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 1.00000 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.47209 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.91309 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.40125 * CGRectGetHeight(chat))];
            ...
            [bezier9Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.62500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.25000 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.54662 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.12500 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.62500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.14125 * CGRectGetHeight(chat))];
            ...
            [bezier9Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.57494 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.47503 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.62500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.41591 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.60522 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.45222 * CGRectGetHeight(chat))];
            [bezier9Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.37500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.37500 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.52931 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.41437 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.45653 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.37500 * CGRectGetHeight(chat))];
            ...
            [bezier9Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.12500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.25000 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.12500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.37500 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.12500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.28094 * CGRectGetHeight(chat))];
            [bezier9Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.25013 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.12500 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.12500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.21266 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.12500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.12500 * CGRectGetHeight(chat))];
            ...
            [bezier9Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.00000 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.25000 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.12500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.00000 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.00000 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.06641 * CGRectGetHeight(chat))];
            [bezier9Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.25013 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.50000 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.00000 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.42969 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.12500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.50000 * CGRectGetHeight(chat))];
            ...
            [bezier9Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.50000 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.62500 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.44409 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.50000 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.50000 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.55603 * CGRectGetHeight(chat))];
            [bezier9Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.75013 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.37500 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.63806 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.62500 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.75013 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.51306 * CGRectGetHeight(chat))];
            ...
            [bezier9Path addCurveToPoint: CGPointMake(CGRectGetMinX(chat) + 0.50000 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.00000 * CGRectGetHeight(chat)) controlPoint1: CGPointMake(CGRectGetMinX(chat) + 0.75013 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.07747 * CGRectGetHeight(chat)) controlPoint2: CGPointMake(CGRectGetMinX(chat) + 0.62500 * CGRectGetWidth(chat), CGRectGetMinY(chat) + 0.00000 * CGRectGetHeight(chat))];
    ...
    //// LEDs
    {
        ...
        CGContextBeginTransparencyLayer(context, NULL);
        [lED3OFFPath addClip];
        CGContextDrawRadialGradient(context, lightOFFGradient,
                                    CGPointMake(219.5, 87.5), 0,
                                    CGPointMake(219.5, 87.5), 12.4,
                                    kCGGradientDrawsBeforeStartLocation | kCGGradientDrawsAfterEndLocation);
        CGContextEndTransparencyLayer(context);
        UIGraphicsPopContext();
        ...
        [lED2OFFPath addClip];
        CGContextDrawRadialGradient(context, lightOFFGradient,
                                    CGPointMake(150.5, 87), 0.14,
                                    CGPointMake(150.5, 87), 12.4,
                                    kCGGradientDrawsBeforeStartLocation | kCGGradientDrawsAfterEndLocation);
        CGContextEndTransparencyLayer(context);
        UIGraphicsPopContext();
        ...
        CGContextBeginTransparencyLayer(context, NULL);
        [lED1ONPath addClip];
        CGContextDrawRadialGradient(context, lightONGradient,
                                    CGPointMake(81.5, 87), 0.14,
                                    CGPointMake(81.5, 87), 12.4,
                                    kCGGradientDrawsBeforeStartLocation | kCGGradientDrawsAfterEndLocation);
        CGContextEndTransparencyLayer(context);
        UIGraphicsPopContext();
    ...
    CGGradientRelease(lightOFFGradient);
    CGGradientRelease(lightONGradient);
    CGGradientRelease(shineLightGradient);
    CGColorSpaceRelease(colorSpace);
...
+ (void)drawPowerButton
{
    ...
    //// Symbol
    {
        ...
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.85355 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.86006 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 1.04882 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.37097 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 1.04882 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.67348 * CGRectGetHeight(symbol))];
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.14645 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.86006 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.65829 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 1.04665 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.34171 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 1.04665 * CGRectGetHeight(symbol))];
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.14645 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.18438 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + -0.04882 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.67348 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + -0.04882 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.37097 * CGRectGetHeight(symbol))];
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.25581 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.18889 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.17353 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.16157 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.22375 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.16086 * CGRectGetHeight(symbol))];
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.26156 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.29438 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.28788 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.21692 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.28490 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.27238 * CGRectGetHeight(symbol))];
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.26156 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.75007 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.12987 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.42021 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.12987 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.62423 * CGRectGetHeight(symbol))];
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.73844 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.75007 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.39325 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.87590 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.60675 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.87590 * CGRectGetHeight(symbol))];
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.73844 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.29438 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.87013 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.62423 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.87013 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.42021 * CGRectGetHeight(symbol))];
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.73844 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.18438 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.70569 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.26272 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.70967 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.21188 * CGRectGetHeight(symbol))];
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.85355 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.18438 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.76722 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.15688 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.83173 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.15986 * CGRectGetHeight(symbol))];
        [symbolOFFPath closePath];
        ...
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.50000 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.60000 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.41860 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.56518 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.45505 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.60000 * CGRectGetHeight(symbol))];
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.58140 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.52222 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.54495 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.60000 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.58140 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.56518 * CGRectGetHeight(symbol))];
        ...
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.50000 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.00000 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.58140 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.03482 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.54495 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.00000 * CGRectGetHeight(symbol))];
        [symbolOFFPath addCurveToPoint: CGPointMake(CGRectGetMinX(symbol) + 0.41860 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.07778 * CGRectGetHeight(symbol)) controlPoint1: CGPointMake(CGRectGetMinX(symbol) + 0.45505 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.00000 * CGRectGetHeight(symbol)) controlPoint2: CGPointMake(CGRectGetMinX(symbol) + 0.41860 * CGRectGetWidth(symbol), CGRectGetMinY(symbol) + 0.03482 * CGRectGetHeight(symbol))];
                                     ...
                                     frame:(CGRect)frame
{
    ...
    //// Color Declarations
    if (!shadowColor)
        shadowColor  = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.8];

    else if (shadowColor.colorSpaceModel != kCGColorSpaceModelRGB)
        shadowColor = [shadowColor rgbColor];
    
    if (!buttonColor)
        buttonColor  = [UIColor colorWithRed:0.18 green:0.631 blue:0 alpha:1];
    ...
    CGGradientRef baseGradient = CGGradientCreateWithColors(colorSpace,
                                                            (__bridge CFArrayRef)baseGradientColors,
    ...
    //// Button
    {
        ...
        CGRect rect = CGRectMake(CGRectGetMinX(frame) + 2,
                                 CGRectGetMinY(frame) + 1,
                                 CGRectGetWidth(frame) - 4,
                                 CGRectGetHeight(frame) - 4);
        
        UIBezierPath * buttonRectanglePath = [UIBezierPath bezierPathWithRoundedRect:rect
                                                                        cornerRadius:7];
        UIGraphicsPushContext(context);
                                        ...
                                        frame:(CGRect)frame
{
    ...
    if (!shineColor) shineColor = [UIColor colorWithRed:0.948 green:0.948 blue:0.948 alpha:0.82];
    UIColor * topShine = [shineColor colorWithAlphaComponent:0.5];
    UIColor * bottomShine = [shineColor colorWithAlphaComponent:0.1];

    //// Gradient Declarations
    NSArray * shineGradientColors = @[(id)shineColor.CGColor,
                                      (id)[UIColor colorWithRed:0.948
                                                          green:0.948
                                                           blue:0.948
                                                          alpha:0.66].CGColor,
                                      (id)topShine.CGColor,
    ...
    //// Button
    {
        ...
        CGRect rect = CGRectMake(CGRectGetMinX(frame) + 2,
                                 CGRectGetMinY(frame) + 1,
                                 CGRectGetWidth(frame) - 4,
                                 floor((CGRectGetHeight(frame) - 1) * 0.48649 + 0.5));
...
+ (void)drawRoundedRectButton
{
    ...
    CGGradientRef baseGradient = CGGradientCreateWithColors(colorSpace,
                                                            (__bridge CFArrayRef)baseGradientColors,
                                                            baseGradientLocations);
    NSArray * shineGradientColors = @[(id)upperShine.CGColor,
                                     (id)[UIColor colorWithRed:0.948
                                                         green:0.948 blue:0.948
                                                         alpha:0.66].CGColor,
                                     (id)topShine.CGColor,
                                     (id)[UIColor colorWithRed:0.948
                                                         green:0.948
    ...
    //// Button
    {
        ...
        //// ButtonRectangle Drawing
        CGRect buttonRectangleRect = CGRectMake(CGRectGetMinX(frame) + 2,
                                                CGRectGetMinY(frame) + 1,
                                                CGRectGetWidth(frame) - 4,
                                                CGRectGetHeight(frame) - 4);
        UIBezierPath * buttonRectanglePath = [UIBezierPath bezierPathWithRoundedRect:buttonRectangleRect
                                                                        cornerRadius:7];
        UIGraphicsPushContext(context);
        CGContextSetShadowWithColor(context,
                                    buttonShadowOffset,
        ...
        CGContextDrawLinearGradient(context,
                                    baseGradient,
                                    CGPointMake(CGRectGetMidX(buttonRectangleRect),
                                                CGRectGetMinY(buttonRectangleRect)),
                                    CGPointMake(CGRectGetMidX(buttonRectangleRect),
                                                CGRectGetMaxY(buttonRectangleRect)),
                                    0);
        CGContextEndTransparencyLayer(context);
        UIGraphicsPopContext();
        ...
        //// Rounded Rectangle Drawing
        //???: Overlay gradient?
        CGRect roundedRectangleRect = CGRectMake(CGRectGetMinX(frame) + 2,
                                                 CGRectGetMinY(frame) + 1,
                                                 CGRectGetWidth(frame) - 4,
                                                 floor((CGRectGetHeight(frame) - 1) * 0.48649 + 0.5));
        UIBezierPath * roundedRectanglePath = [UIBezierPath bezierPathWithRoundedRect:roundedRectangleRect
                                                                         cornerRadius:7];
        UIGraphicsPushContext(context);
        [roundedRectanglePath addClip];
        CGContextDrawLinearGradient(context,
                                    shineGradient,
                                    CGPointMake(CGRectGetMidX(roundedRectangleRect),
                                                CGRectGetMinY(roundedRectangleRect)),
                                    CGPointMake(CGRectGetMidX(roundedRectangleRect),
                                                CGRectGetMaxY(roundedRectangleRect)),
                                    0);
        UIGraphicsPopContext();
...
+ (void)drawResizableButton
{
    ...
    //// Color Declarations
    UIColor* frameColorTop = [UIColor colorWithRed: 0.151 green: 0.151 blue: 0.151 alpha: 1];
    ...
    UIColor* glossyColorUp = [UIColor colorWithRed: (buttonColorRGBA[0] * 0.2 + 0.8) green: (buttonColorRGBA[1] * 0.2 + 0.8) blue: (buttonColorRGBA[2] * 0.2 + 0.8) alpha: (buttonColorRGBA[3] * 0.2 + 0.8)];
    UIColor* glossyColorBottom = [UIColor colorWithRed: (buttonColorRGBA[0] * 0.6 + 0.4) green: (buttonColorRGBA[1] * 0.6 + 0.4) blue: (buttonColorRGBA[2] * 0.6 + 0.4) alpha: (buttonColorRGBA[3] * 0.6 + 0.4)];
...
+ (void)drawBlueButton
{
    ...
    CGContextDrawRadialGradient(context, overlayGradient,
                                CGPointMake(36.5, 12.23), 17.75,
                                CGPointMake(36.5, 36.5), 44.61,
                                kCGGradientDrawsBeforeStartLocation | kCGGradientDrawsAfterEndLocation);
    UIGraphicsPopContext();
    ...
    CGContextDrawRadialGradient(context, buttonGradient,
                                CGPointMake(37, 63.23), 2.44,
                                CGPointMake(37, 44.48), 23.14,
                                kCGGradientDrawsBeforeStartLocation | kCGGradientDrawsAfterEndLocation);
    UIGraphicsPopContext();
...
+ (void)drawGlassShelf
{
    ...
    //// Color Declarations
    UIColor* shineColor = [UIColor colorWithRed: 1 green: 1 blue: 1 alpha: 1];
    UIColor* topColor = [UIColor colorWithRed: 0.63 green: 0.661 blue: 0.651 alpha: 1];
    UIColor* background = [UIColor colorWithRed: 0.282 green: 0.282 blue: 0.282 alpha: 1];
    UIColor* backShadowColor = [UIColor colorWithRed: 0.07 green: 0.168 blue: 0.085 alpha: 0.97];
    UIColor* glassColor = [UIColor colorWithRed: 0.203 green: 0.529 blue: 0.424 alpha: 1];
    CGFloat glassColorRGBA[4];
    [glassColor getRed: &glassColorRGBA[0] green: &glassColorRGBA[1] blue: &glassColorRGBA[2] alpha: &glassColorRGBA[3]];

    CGFloat glassColorHSBA[4];
    [glassColor getHue: &glassColorHSBA[0] saturation: &glassColorHSBA[1] brightness: &glassColorHSBA[2] alpha: &glassColorHSBA[3]];

    UIColor* edgeColor = [UIColor colorWithHue: glassColorHSBA[0] saturation: 0.224 brightness: glassColorHSBA[2] alpha: glassColorHSBA[3]];
    UIColor* glassFrontColor = [UIColor colorWithHue: glassColorHSBA[0] saturation: 0.278 brightness: glassColorHSBA[2] alpha: glassColorHSBA[3]];
    UIColor* glassEdgeColor = [UIColor colorWithRed: (glassColorRGBA[0] * 0.717 + 0.283) green: (glassColorRGBA[1] * 0.717 + 0.283) blue: (glassColorRGBA[2] * 0.717 + 0.283) alpha: (glassColorRGBA[3] * 0.717 + 0.283)];
    UIColor* glassEdgeShine = [UIColor colorWithHue: glassColorHSBA[0] saturation: glassColorHSBA[1] brightness: 1 alpha: glassColorHSBA[3]];
    UIColor* glassFrontTop = [UIColor colorWithHue: glassColorHSBA[0] saturation: glassColorHSBA[1] brightness: 0.397 alpha: glassColorHSBA[3]];
    UIColor* glassFrontBottom = [UIColor colorWithHue: glassColorHSBA[0] saturation: glassColorHSBA[1] brightness: 0.3 alpha: glassColorHSBA[3]];

    //// Gradient Declarations
    NSArray* backGradientColors = [NSArray arrayWithObjects:
                                   (id)shineColor.CGColor,
                                   (id)[UIColor colorWithRed: 0.705 green: 0.764 blue: 0.745 alpha: 1].CGColor,
    ...
    NSArray* topGradientColors = [NSArray arrayWithObjects:
                                  (id)topColor.CGColor,
                                  (id)glassFrontColor.CGColor,
                                  (id)[UIColor colorWithRed: 0.405 green: 0.595 blue: 0.534 alpha: 1].CGColor,
                                  (id)glassEdgeColor.CGColor, nil];
    ...
    NSArray* frontGradientColors = [NSArray arrayWithObjects:
                                    (id)glassEdgeShine.CGColor,
                                    (id)[UIColor colorWithRed: 0.268 green: 0.698 blue: 0.56 alpha: 1].CGColor,
                                    (id)glassFrontTop.CGColor,
                                    (id)glassColor.CGColor,
                                    (id)glassFrontBottom.CGColor, nil];
    ...
    //// shelf
    {
        ...
        [botomShadowRectanglePath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 23.53, CGRectGetMaxY(frame) - 50.5) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 19.5, CGRectGetMaxY(frame) - 48.71) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 21.3, CGRectGetMaxY(frame) - 50.5)];
        [botomShadowRectanglePath addLineToPoint: CGPointMake(CGRectGetMaxX(frame) - 25.53, CGRectGetMaxY(frame) - 50.5)];
        [botomShadowRectanglePath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 21.5, CGRectGetMaxY(frame) - 46.5) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 23.3, CGRectGetMaxY(frame) - 50.5) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 21.5, CGRectGetMaxY(frame) - 48.71)];
        [botomShadowRectanglePath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 42.87, CGRectGetMaxY(frame) - 29.5) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 21.5, CGRectGetMaxY(frame) - 46.5) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 41.7, CGRectGetMaxY(frame) - 29.5)];
        [botomShadowRectanglePath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 38.35, CGRectGetMaxY(frame) - 29.5)];
        [botomShadowRectanglePath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 19.5, CGRectGetMaxY(frame) - 46.5) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 37.17, CGRectGetMaxY(frame) - 29.5) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 19.5, CGRectGetMaxY(frame) - 46.5)];
        ...
        CGContextDrawLinearGradient(context, backGradient,
                                    CGPointMake(CGRectGetMidX(backShadowRectangleBounds), CGRectGetMaxY(backShadowRectangleBounds)),
                                    CGPointMake(CGRectGetMidX(backShadowRectangleBounds), CGRectGetMinY(backShadowRectangleBounds)),
                                    0);
        CGContextEndTransparencyLayer(context);
        UIGraphicsPopContext();
        ...
        CGContextDrawLinearGradient(context, backGradient,
                                    CGPointMake(CGRectGetMidX(topUnderBounds), CGRectGetMaxY(topUnderBounds)),
                                    CGPointMake(CGRectGetMidX(topUnderBounds), CGRectGetMinY(topUnderBounds)),
                                    0);
        UIGraphicsPopContext();
        ...
        CGContextDrawLinearGradient(context, topGradient,
                                    CGPointMake(CGRectGetMidX(topBounds), CGRectGetMaxY(topBounds)),
                                    CGPointMake(CGRectGetMidX(topBounds), CGRectGetMinY(topBounds)),
                                    0);
        UIGraphicsPopContext();
        ...
        UIGraphicsPushContext(context);
        [frontPath addClip];
        CGContextDrawLinearGradient(context, frontGradient,
                                    CGPointMake(CGRectGetMidX(frontRect), CGRectGetMaxY(frontRect)),
                                    CGPointMake(CGRectGetMidX(frontRect), CGRectGetMinY(frontRect)),
                                    0);
        UIGraphicsPopContext();
    }
...
+ (void)drawProgressBar
{
    ...
    //// Color Declarations
    UIColor* highlight = [UIColor colorWithRed: 0.438 green: 0.438 blue: 0.438 alpha: 0.63];
    ...
    UIColor* bottomColor = [UIColor colorWithRed: (topColorRGBA[0] * 0.857) green: (topColorRGBA[1] * 0.857) blue: (topColorRGBA[2] * 0.857) alpha: (topColorRGBA[3] * 0.857 + 0.143)];
    UIColor* whiteEdgeColor = [UIColor colorWithRed: 1 green: 1 blue: 1 alpha: 0.53];
    UIColor* outerShadowColor = [UIColor colorWithRed: 0.699 green: 0.699 blue: 0.699 alpha: 1];
    UIColor* progressColor = [UIColor colorWithRed: 0.885 green: 1 blue: 0 alpha: 1];
    UIColor* activeBarBackColor = [UIColor colorWithRed: 0.533 green: 0.533 blue: 0.533 alpha: 1];

    //// Gradient Declarations
    NSArray* gradientColors = [NSArray arrayWithObjects:
                               (id)topColor.CGColor,
                               (id)[UIColor colorWithRed: 0.929 green: 0.929 blue: 0.929 alpha: 1].CGColor,
    ...
    //// progressBarSheet
    {
        ...
        //// ProgressBar
        {
            ...
            UIGraphicsPushContext(context);
            {
                ...
                CGContextSetShadowWithColor(context,
                                            CGSizeMake(xOffset + copysign(0.1, xOffset), yOffset + copysign(0.1, yOffset)),
                                            whiteEdgeShadowBlurRadius,
                                            whiteEdgeShadow.CGColor);
            ...
            UIGraphicsPushContext(context);
            {
                ...
                CGContextSetShadowWithColor(context,
                                            CGSizeMake(xOffset + copysign(0.1, xOffset), yOffset + copysign(0.1, yOffset)),
                                            trackInnerShadowBlurRadius,
                                            trackInnerShadow.CGColor);
...
{
    //// Color Declarations
    UIColor* sliderColor = [UIColor colorWithRed: 0 green: 0.988 blue: 1 alpha: 1];
    ...
    //// Group
    {
        ...
        [trackPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 18.72, CGRectGetMinY(frame) + 9.5) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 15.22, CGRectGetMinY(frame) + 5.74) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 17.42, CGRectGetMinY(frame) + 9.02)];
        [trackPath addCurveToPoint: CGPointMake(91.01, 12.7) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 20.02, CGRectGetMinY(frame) + 9.98) controlPoint2: CGPointMake(91.01, 12.7)];
        [trackPath addCurveToPoint: CGPointMake(100.13, 20) controlPoint1: CGPointMake(96.6, 12.7) controlPoint2: CGPointMake(100.13, 15.86)];
        [trackPath addCurveToPoint: CGPointMake(91.01, 27.3) controlPoint1: CGPointMake(100.13, 24.14) controlPoint2: CGPointMake(96.6, 27.3)];
        [trackPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 18.72, CGRectGetMinY(frame) + 24.5) controlPoint1: CGPointMake(91.01, 27.3) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 20.02, CGRectGetMinY(frame) + 24.03)];
        [trackPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 10.07, CGRectGetMinY(frame) + 28.3) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 17.41, CGRectGetMinY(frame) + 24.97) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 14.96, CGRectGetMinY(frame) + 28.34)];
        [trackPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 1.28, CGRectGetMinY(frame) + 24.5) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 5.1, CGRectGetMinY(frame) + 28.26) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 2.5, CGRectGetMinY(frame) + 25.07)];
        [trackPath addCurveToPoint: CGPointMake(28.29, 27.3) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 0.07, CGRectGetMinY(frame) + 23.93) controlPoint2: CGPointMake(28.29, 27.3)];
        [trackPath addCurveToPoint: CGPointMake(19.17, 20) controlPoint1: CGPointMake(22.7, 27.3) controlPoint2: CGPointMake(19.17, 24.14)];
        [trackPath addCurveToPoint: CGPointMake(28.29, 12.7) controlPoint1: CGPointMake(19.17, 15.86) controlPoint2: CGPointMake(22.7, 12.7)];
        [trackPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 1.28, CGRectGetMinY(frame) + 9.5) controlPoint1: CGPointMake(28.29, 12.7) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 0.07, CGRectGetMinY(frame) + 10.01)];
        [trackPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 10.01, CGRectGetMinY(frame) + 5.7) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 2.5, CGRectGetMinY(frame) + 8.99) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 4.79, CGRectGetMinY(frame) + 5.66)];
        [trackPath closePath];
        ...
        [rCapPath addCurveToPoint: CGPointMake(97.86, 25.66) controlPoint1: CGPointMake(100.98, 17.47) controlPoint2: CGPointMake(100.98, 22.53)];
        [rCapPath addCurveToPoint: CGPointMake(87, 27.33) controlPoint1: CGPointMake(95.46, 28.05) controlPoint2: CGPointMake(89.93, 28.61)];
        [rCapPath addCurveToPoint: CGPointMake(87.27, 27.07) controlPoint1: CGPointMake(87.09, 27.25) controlPoint2: CGPointMake(87.18, 27.16)];
        [rCapPath addCurveToPoint: CGPointMake(87.27, 12.93) controlPoint1: CGPointMake(91.18, 23.17) controlPoint2: CGPointMake(91.18, 16.83)];
        [rCapPath addCurveToPoint: CGPointMake(87.01, 12.66) controlPoint1: CGPointMake(87.18, 12.84) controlPoint2: CGPointMake(87.09, 12.75)];
        [rCapPath addCurveToPoint: CGPointMake(97.86, 14.34) controlPoint1: CGPointMake(89.94, 11.39) controlPoint2: CGPointMake(95.47, 11.95)];
        [rCapPath closePath];
        ...
        [lCapPath addCurveToPoint: CGPointMake(21.34, 25.66) controlPoint1: CGPointMake(18.22, 17.47) controlPoint2: CGPointMake(18.22, 22.53)];
        [lCapPath addCurveToPoint: CGPointMake(32.2, 27.33) controlPoint1: CGPointMake(23.74, 28.05) controlPoint2: CGPointMake(29.28, 28.61)];
        [lCapPath addCurveToPoint: CGPointMake(31.93, 27.07) controlPoint1: CGPointMake(32.11, 27.25) controlPoint2: CGPointMake(32.02, 27.16)];
        [lCapPath addCurveToPoint: CGPointMake(31.93, 12.93) controlPoint1: CGPointMake(28.02, 23.17) controlPoint2: CGPointMake(28.02, 16.83)];
        [lCapPath addCurveToPoint: CGPointMake(32.19, 12.66) controlPoint1: CGPointMake(32.02, 12.84) controlPoint2: CGPointMake(32.11, 12.75)];
        [lCapPath addCurveToPoint: CGPointMake(21.34, 14.34) controlPoint1: CGPointMake(29.26, 11.39) controlPoint2: CGPointMake(23.74, 11.95)];
        [lCapPath closePath];
...
+ (void)drawCMYPad
{
    ...
    //// Color Declarations
    UIColor* c = [UIColor colorWithRed: 0 green: 0.573 blue: 0.821 alpha: 1];
    UIColor* k = [UIColor colorWithRed: 0.3 green: 0.3 blue: 0.3 alpha: 1];
    UIColor* m = [UIColor colorWithRed: 0.801 green: 0 blue: 0.417 alpha: 1];
    UIColor* y = [UIColor colorWithRed: 0.967 green: 0.896 blue: 0.084 alpha: 1];

    //// pad Drawing
    UIBezierPath* padPath = [UIBezierPath bezierPath];
    [padPath moveToPoint: CGPointMake(60, 21.59)];
    [padPath addCurveToPoint: CGPointMake(95.86, 26.14) controlPoint1: CGPointMake(71.31, 14.9) controlPoint2: CGPointMake(86.14, 16.42)];
    [padPath addCurveToPoint: CGPointMake(95.86, 67.86) controlPoint1: CGPointMake(107.38, 37.66) controlPoint2: CGPointMake(107.38, 56.34)];
    [padPath addCurveToPoint: CGPointMake(89.41, 72.75) controlPoint1: CGPointMake(93.9, 69.82) controlPoint2: CGPointMake(91.72, 71.45)];
    [padPath addCurveToPoint: CGPointMake(80.86, 95.86) controlPoint1: CGPointMake(90.04, 81.03) controlPoint2: CGPointMake(87.19, 89.53)];
    [padPath addCurveToPoint: CGPointMake(39.14, 95.86) controlPoint1: CGPointMake(69.34, 107.38) controlPoint2: CGPointMake(50.66, 107.38)];
    [padPath addCurveToPoint: CGPointMake(30.59, 72.75) controlPoint1: CGPointMake(32.81, 89.53) controlPoint2: CGPointMake(29.96, 81.03)];
    [padPath addCurveToPoint: CGPointMake(24.14, 67.86) controlPoint1: CGPointMake(28.28, 71.45) controlPoint2: CGPointMake(26.1, 69.82)];
    [padPath addCurveToPoint: CGPointMake(24.14, 26.14) controlPoint1: CGPointMake(12.62, 56.34) controlPoint2: CGPointMake(12.62, 37.66)];
    [padPath addCurveToPoint: CGPointMake(60, 21.59) controlPoint1: CGPointMake(33.86, 16.42) controlPoint2: CGPointMake(48.69, 14.9)];
    [padPath closePath];
    [[UIColor whiteColor] setFill];
    [padPath fill];
    [[UIColor whiteColor] setStroke];
