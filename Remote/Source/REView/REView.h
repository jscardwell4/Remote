...
MSKIT_EXTERN_STRING   RERemoteTopPanel1Key;
MSKIT_EXTERN_STRING   RERemoteBottomPanel1Key;
MSKIT_EXTERN_STRING   RERemoteLeftPanel1Key;
MSKIT_EXTERN_STRING   RERemoteRightPanel1Key;
MSKIT_EXTERN_STRING   RERemoteTopPanel2Key;
MSKIT_EXTERN_STRING   RERemoteBottomPanel2Key;
MSKIT_EXTERN_STRING   RERemoteLeftPanel2Key;
MSKIT_EXTERN_STRING   RERemoteRightPanel2Key;
MSKIT_EXTERN_STRING   RERemoteTopPanel3Key;
MSKIT_EXTERN_STRING   RERemoteBottomPanel3Key;
MSKIT_EXTERN_STRING   RERemoteLeftPanel3Key;
MSKIT_EXTERN_STRING   RERemoteRightPanel3Key;
...
MSKIT_EXTERN_STRING   REButtonGroupTuckButtonKey;
MSKIT_EXTERN_STRING   REButtonGroupViewPanelNametag;
MSKIT_EXTERN_STRING   REButtonGroupViewInternalNametag;
MSKIT_EXTERN_STRING   REButtonGroupViewLabelNametag;
...
MSKIT_EXTERN_STRING REPickerLabelButtonGroupViewInternalNametag;

MSKIT_EXTERN_STRING REPickerLabelButtonGroupViewLabelContainer;
...
MSKIT_EXTERN_STRING   REButtonViewInternalNametag;
MSKIT_EXTERN_STRING   REButtonViewLabelNametag;
MSKIT_EXTERN_STRING   REButtonViewActivityIndicatorNametag;
...
@class   BOButtonImage, BOIconImage, REButtonConfigurationDelegate;
