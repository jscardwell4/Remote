...
+ (instancetype)viewWithModel:(RemoteElement *)model
{
    ...
    dispatch_once(&onceToken, ^{
        kClassMap = @{ @(RETypeUndefined)                 : NullObject,
                       @(RETypeRemote)                    : @"RERemoteView",
                       @(RETypeButtonGroup)               : @"REButtonGroupView",
                       @(RETypeButton)                    : @"REButtonView",
                       @(REButtonGroupTypePanel)          : @"REButtonGroupView",
                       ...
                       @(REButtonGroupTypeNumberpad)      : @"REButtonGroupView",
                       @(REButtonGroupTypeTransport)      : @"REButtonGroupView",
                       @(REButtonGroupTypePickerLabel)    : @"REPickerLabelButtonGroupView",
                       @(REButtonTypeToolbar)             : @"REButtonView",
                       @(REButtonTypeConnectionStatus)    : @"REConnectionStatusButtonView",
                       @(REButtonTypeBatteryStatus)       : @"REBatteryStatusButtonView",
                       @(REButtonTypePickerLabel)         : @"REButtonView",
                       @(REButtonTypePickerLabelTop)      : @"REButtonView",
                       @(REButtonTypePickerLabelBottom)   : @"REButtonView",
                       @(REButtonTypePanel)               : @"REButtonView",
                       @(REButtonTypeTuck)                : @"REButtonView",
                       @(REButtonTypeSelectionPanel)      : @"REButtonView",
                       @(REButtonTypeDPad)                : @"REButtonView",
                       @(REButtonTypeDPadUp)              : @"REButtonView",
                       @(REButtonTypeDPadDown)            : @"REButtonView",
                       @(REButtonTypeDPadLeft)            : @"REButtonView",
                       @(REButtonTypeDPadRight)           : @"REButtonView",
                       @(REButtonTypeDPadCenter)          : @"REButtonView",
                       @(REButtonTypeNumberpad)           : @"REButtonView",
                       @(REButtonTypeNumberpad1)          : @"REButtonView",
                       @(REButtonTypeNumberpad2)          : @"REButtonView",
                       @(REButtonTypeNumberpad3)          : @"REButtonView",
                       @(REButtonTypeNumberpad4)          : @"REButtonView",
                       @(REButtonTypeNumberpad5)          : @"REButtonView",
                       @(REButtonTypeNumberpad6)          : @"REButtonView",
                       @(REButtonTypeNumberpad7)          : @"REButtonView",
                       @(REButtonTypeNumberpad8)          : @"REButtonView",
                       @(REButtonTypeNumberpad9)          : @"REButtonView",
                       @(REButtonTypeNumberpad0)          : @"REButtonView",
                       @(REButtonTypeNumberpadAux1)       : @"REButtonView",
                       @(REButtonTypeNumberpadAux2)       : @"REButtonView",
                       @(REButtonTypeTransport)           : @"REButtonView",
                       @(REButtonTypeTransportPlay)       : @"REButtonView",
                       @(REButtonTypeTransportStop)       : @"REButtonView",
                       @(REButtonTypeTransportPause)      : @"REButtonView",
                       @(REButtonTypeTransportSkip)       : @"REButtonView",
                       @(REButtonTypeTransportReplay)     : @"REButtonView",
                       @(REButtonTypeTransportFF)         : @"REButtonView",
                       @(REButtonTypeTransportRewind)     : @"REButtonView",
                       @(REButtonTypeTransportRecord)     : @"REButtonView" };
