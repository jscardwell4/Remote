...
@class REActivityButton, RERemote, RERemoteController, REMacroCommand;

@interface REActivity : MSModelObject <MSNamedModelObject>
...
@property (nonatomic, strong) REMacroCommand * launchMacro;
...
@property (nonatomic, strong) REMacroCommand * haltMacro;
