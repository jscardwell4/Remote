...
////////////////////////////////////////////////////////////////////////////////
@interface REEditingViewController () <REEditingDelegate> {
    struct {
        BOOL                            testInProgress;
   ...
   __weak id <REEditingDelegate>   _delegate;
...
@interface RERemoteEditingViewController () <MSPickerInputButtonDelegate>
...
@interface REButtonGroupEditingViewController () <MSPickerInputButtonDelegate>
