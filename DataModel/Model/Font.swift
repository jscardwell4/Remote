...
public struct UIFontDescriptorSymbolicTraits : RawOptionSetType {
  ...
  /*
  UIFontDescriptorSymbolicTraits symbolically describes stylistic aspects of a font. The upper 16 bits is used to describe 
  appearance of the font whereas the lower 16 bits for typeface. The font appearance information represented by the upper 
  16 bits can be used for stylistic font matching.
  */
  ...
  static var TraitMonoSpace: UIFontDescriptorSymbolicTraits { get } // Use fixed-pitch glyphs if available. May have multiple 
                                                                       glyph advances (most CJK glyphs may contain two spaces)
  static var TraitVertical: UIFontDescriptorSymbolicTraits { get } // Use vertical glyph variants and metrics
  static var TraitUIOptimized: UIFontDescriptorSymbolicTraits { get } // Synthesize appropriate attributes for UI rendering 
                                                                         such as control titles if necessary
  ...
  /* 
  UIFontDescriptorClassFamily classifies certain stylistic qualities of the font. These values correspond closely to
  the font class values in the OpenType 'OS/2' table. The class values are bundled in the upper four bits of the 
  UIFontDescriptorSymbolicTraits and can be accessed via UIFontDescriptorClassMask. For specific meaning of each identifier, 
  refer to the OpenType specification.
  */
